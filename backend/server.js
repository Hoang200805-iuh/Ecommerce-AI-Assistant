...
db.serialize(() => {
  ...
  db.run('ALTER TABLE phones ADD COLUMN stock INTEGER DEFAULT 10', () => {
    db.run('UPDATE phones SET stock = COALESCE(stock, 10)')
  });
  db.run('ALTER TABLE phones ADD COLUMN min_stock INTEGER DEFAULT 10', () => {
    db.run('UPDATE phones SET min_stock = COALESCE(min_stock, 10)')
  });
  db.run('ALTER TABLE phones ADD COLUMN category TEXT');
  db.run('ALTER TABLE phones ADD COLUMN ram TEXT');
  db.run('ALTER TABLE phones ADD COLUMN rom TEXT');
  db.run('ALTER TABLE phones ADD COLUMN battery TEXT');
  db.run('ALTER TABLE phones ADD COLUMN review_count INTEGER DEFAULT 0');
  db.run(`
